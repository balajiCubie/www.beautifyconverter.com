$("#seconds-to-human-submit").click(function(e){e.preventDefault();var text=$('#seconds-to-human-text').val();if(text=="")
{$("#seconds-to-human-text").focus().parents("div.form-group").addClass("has-error");return false;}else
{$("#seconds-to-human-text").parents("div.form-group").removeClass("has-error");$("html, body").animate({scrollTop:($("h1").offset().top-10)},600);}
...
ret+='\n';}
$("#res").val(ret);});$("#clear").click(function(e){e.preventDefault();$("#seconds-to-human-text,#res").val("");$("#seconds-to-human-text").parents("div.form-group").removeClass("has-error");$("html, body").animate({scrollTop:($("html").offset().top-10)},600);});