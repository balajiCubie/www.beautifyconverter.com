...
{output+="<td>"+col[j]+"</td>";}
output+="</tr>";}
var starthtml="<table>";var endhtml="</table>"
...
var tabtitle=$("#tabtitle").val();var doc=new jsPDF(htable,'pt');doc.text(tabtitle,40,40);var res=doc.autoTableHtmlToJson(document.getElementById("data_out_tb"));doc.autoTable(res.columns,res.data,{startY:50,theme:pdfthemee,styles:{overflow:lin},});document.getElementById("output").src=doc.output('datauristring');}catch(e){errorData="";errorData=errorData+"Error : "+e['message'];if(e['parsedLine']!=undefined)
...
return s4()+s4()+'-'+s4();};function onTagChange(){$("#convert").click();};