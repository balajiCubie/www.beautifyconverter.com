...
var tabtitle=$("#tabtitle").val();var doc=new jsPDF(htable,'pt');doc.text(tabtitle,40,40);var res=doc.autoTableHtmlToJson(document.getElementById("data_out_tb"));doc.autoTable(res.columns,res.data,{startY:50,theme:pdfthemee,styles:{overflow:lin},});document.getElementById("output").src=doc.output('datauristring');}});$("#preview").click(function(e){e.preventDefault();if($.trim(editorAce2.getValue())=="")
{$("#convert").click();}
