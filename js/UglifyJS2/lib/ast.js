...
var AST_Token = DEFNODE(
  "Token",
  "type value line col pos endline endcol endpos nlb comments_before file",
  {},
  null
);
...
var AST_Toplevel = DEFNODE(
  ...
  "globals",
  {
    ...
    wrap_commonjs: function (name, export_all) {
      ...
      var wrapped_tl =
        "(function(exports, global){ global['" +
        name +
        "'] = exports; '$ORIG'; '$EXPORTS'; }({}, (function(){return this}())))";
      wrapped_tl = parse(wrapped_tl);
      wrapped_tl = wrapped_tl.transform(
        new TreeTransformer(function before(node) {
...
TreeWalker.prototype = {
  ...
  in_boolean_context: function () {
    ...
    while (i > 0) {
      ...
      if (
        !(p instanceof AST_Binary && (p.operator == "&&" || p.operator == "||"))
      )
        return false;
      self = p;
    }
